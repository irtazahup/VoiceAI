...
async def get_processing_status(
    ...
    if recording.summary:
        result["summary_status"] = recording.summary.status
    
    return result

@app.get("/recordings/{recording_id}/summary", response_model=SummaryResponse)
...
@app.post("/recordings/{recording_id}/process-now")
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=8003)  # Using port 8003
